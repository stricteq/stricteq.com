...
<footer role=contentinfo>
  ...
  <a class=spaced href=mailto:support@griffarins.com>Support</a>
  <a class=spaced href=https://twitter.com/${constants.twitter}>Twitter</a>
  <p>Built on <a href=/credits.txt>open code</a>. Source <a href=https://github.com/griffarins/griffarins.com>on GitHub</a>.</p>
  <p>
      ...
      // Notify the administrator.
        ...
        mail({
          ...
          text: [
            ...
            `Blog?: ${body.blog}`,
            `Tweet?: ${body.tweet}`,
            `URL: <https://griffarins.com/${handle}/${project}`
          ].join('\n\n')
        }, error => {
          // Eat errors.
          if (error) request.log.error(error)
...
<p>
  ...
  Please <a href=mailto:support@griffarins.com>e-mail us</a> about the changes you’d like to make.
</p>
`
  ...
  <body>
    <main role=main>
      ...
      <p>
        ...
        <a href=mailto:support@griffarins.com>e-mail support</a>,
