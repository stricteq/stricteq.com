...
<footer role=contentinfo>
  ...
  <a class=spaced href=mailto:${constants.support}>Support</a>
  <a class=spaced href=https://twitter.com/${constants.twitter}>Twitter</a>
  <p>Built on <a href=/credits.txt>open code</a>. Source <a href=${constants.github}>on GitHub</a>.</p>
  <p>
...
<html lang=en-US>
  <head>
    ${meta({ title: constants.website + ' ' + title, description: summary })}
    <title>${escapeHTML(title)}</title>
  </head>
  <body>
    ${nav(request)}
